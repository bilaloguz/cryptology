 ...
 * @param table Custom Beaufort table (uses classical if NULL)
...
/**
 * @brief Create classical Beaufort table (same as Vigenère tabula recta)
 * 
...
/**
 * @brief Create Beaufort table where each row uses Caesar cipher with different offsets
 * 
 * @param alphabet The alphabet to use for the table
...
/**
 * @brief Create Beaufort table where each row uses Affine cipher with different offsets
 * 
 * @param alphabet The alphabet to use for the table
...
/**
 * @brief Create Beaufort table where each row uses Keyword cipher with different keywords
 * 
 * @param alphabet The alphabet to use for the table
...
/**
 * @brief Create Beaufort table where each row uses Atbash cipher with different offsets
 * 
 * @param alphabet The alphabet to use for the table
 * @param table Pointer to store the generated table
 * @return 0 on success, -1 on error
...
/**
 * @brief Produce a Beaufort table using different strategies
 * 
...
/**
 * @brief Encrypt plaintext using Beaufort cipher
 * 
 * @param plaintext The text to encrypt
 * @param key The Beaufort key
 * @param table Custom Beaufort table (uses classical if NULL)
...
/**
 * @brief Decrypt ciphertext using Beaufort cipher
 * 
